...
@ConditionalOnProperty(prefix = "morpho", name = "swagger-open", havingValue = "true")
public class SpringfoxConfig {
	...
	private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("系统接口文档")
                .description("系统接口文档")
                .termsOfServiceUrl("https://git.oschina.net/max256/morpho-springboot")
                .contact("help@max256.com")
                .version("2.0")
                .build();
    }
