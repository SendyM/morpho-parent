...
public class DruidProperties {
    ...
    private String url = "jdbc:mysql://127.0.0.1:3306/morpho?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";
    ...
    private Boolean logSlowSql = true; //开启慢查询日志
    
    private Integer slowSqlMillis=30000;// 多久算慢查询
    
    private Boolean mergeSql = true; //
    
    private Boolean enableWebAdmin = true; //
    private String webAdminUsername="admin";
    private String webAdminPassword="admin";
    
    
    

	public String getWebAdminUsername() {
		return webAdminUsername;
	}

	public void setWebAdminUsername(String webAdminUsername) {
		this.webAdminUsername = webAdminUsername;
	}
	...
	public void setEnableWebAdmin(Boolean enableWebAdmin) {
